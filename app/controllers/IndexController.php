...
class IndexController extends ControllerBase{
	...
	public function indexAction(){
	    //pq le cache quand utiliser composer et comment dl semantic
	...
	public function demoAction()
    {
        ...
        $card=$semantic->htmlCard("card");
        $card->addImage("http://gamerqc.com/wp-content/uploads/2016/05/persona-5.png");
        $card->addCardHeaderContent("Jean-Luc","Ouf !!!!!!!!!");
        $this->jquery->compile($this->view);
    }
